...
//---模組狀態資訊---//
$modversion['release_date'] = '2021-11-1';
...
//---樣板設定---//
$modversion['templates'][] = ['file' => 'hcc_sighup_admin.tpl', 'description' => '後台共同樣板'];
$modversion['templates'][] = ['file' => 'hcc_sighup_index.tpl', 'description' => '前台共同樣板'];
